      ...
      <div className="container-wide">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          <div className="lg:col-span-2">
            ...
            <address className="not-italic space-y-3">
              <a
                ...
                className="flex items-center gap-3 text-secondary-foreground/70 hover:text-secondary-foreground transition-colors focus-ring rounded"
            ...
            <div className="flex items-center gap-4 mt-6">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 text-sm text-secondary-foreground/70 hover:text-secondary-foreground transition-colors focus-ring rounded"
          ...
          <nav aria-label="Footer navigation">
            <h3 className="font-semibold mb-4 text-secondary-foreground/90">Quick Links</h3>
            <ul className="flex flex-col gap-2">
              {footer.links.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-secondary-foreground/60 hover:text-secondary-foreground transition-colors focus-ring rounded"
          ...
          <div>
            <h3 className="font-semibold mb-4 text-secondary-foreground/90">Hours</h3>
